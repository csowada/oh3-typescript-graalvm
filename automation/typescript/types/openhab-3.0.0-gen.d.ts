...
class DateTimeType/* extends java.lang.Object implements org.openhab.core.types.PrimitiveType, org.openhab.core.types.State, org.openhab.core.types.Command*/ {
	...
	getZonedDateTime(  ):any /*java.time.ZonedDateTime*/;
	static valueOf( arg0:string ):DateTimeType;
	toFullString(  ):string;
...
class LocalDate/* extends java.lang.Object implements java.time.temporal.Temporal, java.time.temporal.TemporalAdjuster, java.time.chrono.ChronoLocalDate, java.io.Serializable*/ {
	...
	atStartOfDay( arg0:any /*java.time.ZoneId*/ ):any /*java.time.ZonedDateTime*/;
...
class LocalDateTime/* extends java.lang.Object implements java.time.temporal.Temporal, java.time.temporal.TemporalAdjuster, java.time.chrono.ChronoLocalDateTime<any>, java.io.Serializable*/ {
	...
	atZone( arg0:any /*java.time.ZoneId*/ ):any /*java.time.ZonedDateTime*/;
...
class RawType/* extends java.lang.Object implements org.openhab.core.types.PrimitiveType, org.openhab.core.types.State*/ {
	...
	getBytes(  ):bytearray;
	getMimeType(  ):string;
	static valueOf( arg0:string ):RawType;
	toFullString(  ):string;
	toString(  ):string;
...
class StringListType/* extends java.lang.Object implements org.openhab.core.types.Command, org.openhab.core.types.State*/ {
	...
	static valueOf( arg0:string ):StringListType;
	toFullString(  ):string;
	toString(  ):string;
...
class DecimalType/* extends java.lang.Number implements org.openhab.core.types.PrimitiveType, org.openhab.core.types.State, org.openhab.core.types.Command, java.lang.Comparable<any>*/ {
	...
	static valueOf( arg0:string ):DecimalType;
...
class PointType/* extends java.lang.Object implements org.openhab.core.types.ComplexType, org.openhab.core.types.Command, org.openhab.core.types.State*/ {
	...
	static valueOf( arg0:string ):PointType;
	toFullString(  ):string;
	toString(  ):string;
...
class OffsetDateTime/* extends java.lang.Object implements java.time.temporal.Temporal, java.time.temporal.TemporalAdjuster, java.lang.Comparable<any>, java.io.Serializable*/ {
	...
	adjustInto( arg0:java.time.temporal.Temporal ):java.time.temporal.Temporal;
	atZoneSameInstant( arg0:any /*java.time.ZoneId*/ ):any /*java.time.ZonedDateTime*/;
	atZoneSimilarLocal( arg0:any /*java.time.ZoneId*/ ):any /*java.time.ZonedDateTime*/;
...
class StringType/* extends java.lang.Object implements org.openhab.core.types.PrimitiveType, org.openhab.core.types.State, org.openhab.core.types.Command*/ {
	...
	equals( arg0:any /*java.lang.Object*/ ):boolean;
	format( arg0:string ):string;
	static valueOf( arg0:string ):StringType;
	toFullString(  ):string;
	toString(  ):string;
...
class PercentType/* extends DecimalType*/ {
	...
	shortValue(  ):any /*short*/;
	static valueOf( arg0:string ):DecimalType;
	static valueOf( arg0:string ):PercentType;
	toBigDecimal(  ):java.math.BigDecimal;
	toFullString(  ):string;
	toString(  ):string;
